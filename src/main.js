...
var backToMainUnButton = document.querySelector(".back-to-main-un");
...
function unmotivationalbackToMain(){
  unmotivationalArea.classList.add("hidden")  
  mainPoster.classList.remove("hidden")
}
...
function cleanData() {
  for (var i = 0; i < unmotivationalPosters.length; i++) {
    ...
    cleanDataArray.push(cleanedPoster)
  }
